...
const games = [];
/**
 * Byrjar leikinn okkar með því að kalla í play(). KOMIÐ
 * Eftir að play() klárar þá er boðið notandanum að spila annann leik með confirm() KOMIÐ
 * Ef notandi ýtir á "ok" þá er annar leikur spilaður. KOMIÐ
 ...
 *  - Velja tölu af handahófi í byrjun með randomNumber() KOMIÐ
 *  - Biðja notanda um tölu með prompt() KOMIÐ
 *  - Vinna úr intaki frá notanda með parseGuess() KOMIÐ
...
function play() {
  ...
  let guess = 0;
  while (guess !== random) {
    guess = prompt("Veldu tölu á milli 1-100");
  ...
  games[games.length] = numberOfGuess; //ath hvað
}
...
/**
 * tekur in input sem streng og skilar þeirri tölu sem hægt er að ná þar úr. KOMIÐ
 * Ef ekki er hægt að ná tölu úr input er skilað null KOMIÐ
 */
